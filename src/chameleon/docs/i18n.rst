...
Internationalization support is provided via the ``i18n`` namespace
and a *translation domain*. It's required to use the Zope Component
Architecture to register translation domains.
