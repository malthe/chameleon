...
chameleon_version = distribution_version('Chameleon')
...
project = u'Chameleon'
copyright = u'2008-2017 by Malthe Borch and the Repoze Community'
...
version = '%s.%s' % tuple(map(int, chameleon_version.split('.')[:2]))
# The full version, including alpha/beta/rc tags.
release = chameleon_version
